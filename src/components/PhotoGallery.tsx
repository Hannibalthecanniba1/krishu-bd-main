...
import songA from "./music/everybreath.mp3";
import songB from "./music/neonmoon.mp3";
import songC from "./music/notalotjustforever.mp3";
...
const photos: Photo[] = [
  {
    url: Pic1,
    caption: "So many places, but only one feels like Home—YOU DUMB AURAT KRISHU!🎀...",
  },
  {
    url: Pic2,
    caption: "Our eyes, out laugh said it first! Yep we are stuck for life😭🙏🏿🎀...",
  },
  {
    url: Pic3,
    caption: "Your hand feels like home- My favourite place to be...",
  },
];

// Extra photos for a sticky note gallery
const extraPhotos: Photo[] = [
  { url: Pic4, caption: "MY PRETTY LADY HAHA" },
  { url: Pic5, caption: " Our First Date 'she looks tired eh' haha" },
];
...
const TimelineComponent: React.FC<{ onProceed: () => void }> = ({ onProceed }) => {
  const timelineEvents = [
    { icon: "🌟", title: "A First Date With Destiny!", desc: "at Piccolo! (4/6/24)" },
    { icon: "💗", title: "The First Time You Held My Hand", desc: "03:16PM (4/6/24)," },
    { icon: "🫂", title: "Our First Hug, Where I Belong", desc: "PICCOLO 4:23PM (4/6/25)" },
    { icon: "✨", title: "To be continued...", desc: "countless memories are still waiting for us." }
  ];
  ...
  return (
    <div className="min-h-screen px-4 sm:px-8 md:px-10 py-10 bg-white animate-fade-in"
      ...
      >
        ...
        <div className="hidden sm:block absolute left-1/2 top-1 transform -translate-x-1 h-full w-1 bg-white opacity-75"></div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="mt-2 text-center text-gray-700 text-lg font-semibold mb-8">
            ...
            <div className="flex flex-col justify-center space-y-10">
              ...
              <div className="backdrop-blur-lg bg-white/40 rounded-2xl p-8 shadow-2xl border-2 border-orange-300">
                <h3 className="text-3xl font-bold text-orange-800 mb-6 flex items-center">
                  <span className="mr-3">🎶</span> Our Melodies!
                </h3>
