  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-20">
        <h1 className="text-3xl font-bold text-red-500 drop-shadow-lg">krishu apne SMOL YUM jaise Haatho ka Jalwa dikhaoo!</h1>
      ...
      {score >= REWARD_THRESHOLD && (
        ...
        >
          <h2 className="text-4xl font-bold text-yellow-600 text-center">
            Krishu ka Swag For A REASON😭🙏🏿!!
          </h2>
          <p className="mt-4 text-lg text-gray-800 text-center">
            Nhi Ud rha ek rehepte me janu😞🤚🏻!
          </p>
        </motion.div>
      )}
      ...
      {score >= REWARD_THRESHOLD && (
        ...
        >
          ...
          Chalo Janu Apni Khoobsurati ka Jalwa Dikhane🙏🏿🎀 →
        </motion.button>
      )}
    </motion.div>
  );
